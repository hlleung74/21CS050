classdef InputSignalViaRSP < handle
    ...
    %
    %   extracted from https://ww2.mathworks.cn/matlabcentral/fileexchange/67816-sdrplay-rsp2-matlab-toolbox
    ...
    properties (SetObservable)
        ...
        Bandwidth           % Set RSP Bandwidth, see table for details.
    ...
    methods
        ...
        function obj = InputSignalViaRSP
            Open(obj)
        end
